...
export default function Page() {
    return (
        <div className="flex min-h-screen items-center justify-center bg-black relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-violet-600/20 rounded-full blur-[120px] -z-10 animate-pulse delay-700" />

            <div className="relative">
                <div className="absolute -inset-0.5 bg-linear-to-r from-violet-600 to-primary rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                <SignUp
                    appearance={{
                        elements: {
                            ...
                            formFieldInput: "bg-white/10 border-white/10 text-white focus:ring-primary/50",
