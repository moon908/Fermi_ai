                ...
                <div className="flex justify-center mt-6">
                    <Link href="/chat">
                        <Button
                            ...
                            className="bg-black/40 backdrop-blur-xl text-white border-white/10 flex items-center gap-3 px-8 py-3 transition-transform duration-300 hover:scale-[1.02]"
                        >
